...
| Role | Username | Email | Name / Designation |
| :--- | :--- | :--- | :--- |
| **Student (3rd Yr CSE A)** | `student1` | `aarav.patel@student.college.edu` | Aarav Patel (Reg: 22CS001) |
| **Student (3rd Yr CSE A)** | `student2` | `bhavya.sharma@student.college.edu` | Bhavya Sharma (Reg: 22CS002) |
| **Student (3rd Yr CSE B)** | `student6` | `farhan.khan@student.college.edu` | Farhan Khan (Reg: 22CS006) |
| **Faculty (Class Advisor 3A)** | `faculty1` | `prof.ramesh@college.edu` | Prof. Ramesh Kumar |
| **Faculty (Mentor 3A)** | `faculty2` | `dr.ananya@college.edu` | Dr. Ananya Sharma |
| **Faculty (Class Advisor 3B)** | `faculty3` | `prof.venkat@college.edu` | Prof. S. Venkatesh |
| **HOD / Admin** | `admin` | `hod.cse@college.edu` | Dr. K. Balasubramanian (HOD CSE) |

> 💡 **Quick Login Tip:** On the Login page and Topbar, click any of the **Quick Demo Chips** to log in as that user instantly.
